        ...
        function showColumn(it, box) {
            var vis = (box.checked) ? "table-cell" : "none";
        ...
        function getSections() {
            ...
            var legalArea =  document.getElementById("legalQs");
            ...
            if (cab == true && (caType1 == false && caType2 == false && caType3 == false)) {
                alert("Please enter a selection for 'Cash Assistance Type?'");
                return;
            }
        ...
        function createDDD() {
            ...
            for (h = 0; h < rows.length-1; h++) {
                ...
                if (dddName != "" && dddUnder65 < 65 && dddApply == true && dddDisab == true && dddBuilt == false) {
                    ...
                    iLab.setAttribute('for','dddScreenA' + i );
                    iLab.id = 'dddQuestA' + i;
        ...
        function buildAbawdMems(array) {
            ...
            if (abawdMemsList.length == 1) {
                document.getElementById('abawdUsedTLDiv').style.display = "block";
        ...
        function newHHMember () {
            ...
            t5.type="checkbox";
            t5.id="disq" + memNum;
            t5.setAttribute('aria-labelledby', 'disq');
    ...
    function copyCLRCtext () {
        var clrcInfo = document.getElementById("clrcInfo")
        clrcInfo.select();
